...
class SimpleGuardrailAgent:
    ...
    def process_paragraph(self, paragraph: str) -> str:
        logger.info("Starting processing of paragraph for audit logging")
        ...
        if not paragraph.strip():
            ...
            logger.info("Audit log: Rejected input - empty paragraph")
        ...
        if len(paragraph) > max_length:
            ...
            logger.info(f"Audit log: Input truncated from {len(paragraph)} to {max_length} characters")
        ...
        #     logger.info("Audit log: Rejected input - digits not allowed")
        ...
        if not any(keyword in lower_paragraph for keyword in backup_keywords):
            ...
            logger.info("Audit log: Rejected input - not related to backup or snapshot")
        ...
        logger.info("Audit log: Successfully processed paragraph")
        return result
